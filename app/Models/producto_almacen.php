...
{
    protected $table = 'producto_almacen'; //inidica a que tabla va a direccionarse este modelo
    protected $primaryKey = 'producto_almacen_id'; // indica cual es la columna de conexión con esa tabla
