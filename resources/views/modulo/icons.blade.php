                            ...
                            <div class="page-title-box">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        ...
                                        <li class="breadcrumb-item active">Two Tone Icons</li>
                                    </ol>
                                </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-3">Use <code>&lt;i data-feather="activity"
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="mb-3">Use <code>&lt;i data-feather="activity"
                                            class="icons-**"&gt;&lt;/i&gt;</code>. Available sizes
                                        <code>sm,md,lg,xl,xxl</code></p>
