                ...
                <ul class="menu">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuDashboards">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="{{ url('almacen/categoria') }}" class="menu-link">
                                        <span class="menu-text">Categoria</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ url('almacen/producto') }}" class="menu-link">
                                        <span class="menu-text">Producto</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ url('almacen/proveedor') }}" class="menu-link">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuEcommerce">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="{{ url('comercial/cliente') }}" class="menu-link">
                                        <span class="menu-text">Clientes</span>
                                    </a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ url('comercial/compra') }}" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="#menuCrm" data-bs-toggle="collapse" class="menu-link">
                            ...
                            <span class="menu-text"> Talento </span>
                            <span class="menu-arrow"></span>
                        </a>
                        <div class="collapse" id="menuCrm">
                            <ul class="sub-menu">
                                <li class="menu-item">
                                    <a href="{{ url('rrhh/usuario') }}" class="menu-link">
                    ...
                    <ul class="topbar-menu d-flex align-items-center">
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg p-0">
                                <form class="p-3">
                                    <input type="search" class="form-control" placeholder="Search ..."
                                        aria-label="Recipient's username" id="sert">
                                </form>
                            </div>
                        </li>
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                                ...
                                <div class="p-2">
                                    <div class="row g-0">
                                        ...
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="{{ asset('images/brands/dribbble.png') }}"
                                                    alt="dribbble">
                                                <span>Dribbble</span>
                                            </a>
                                        </div>
                                    ...
                                    <div class="row g-0">
                                        <div class="col">
                                            <a class="dropdown-icon-item" href="#">
                                                <img src="{{ asset('images/brands/bitbucket.png') }}"
                                                    alt="bitbucket">
                                                <span>Bitbucket</span>
                                            </a>
                                        </div>
                        ...
                        <li class="dropdown d-none d-md-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
                                ...
                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{ asset('images/flags/germany.jpg') }}" alt="user-image"
                                        class="me-1" height="12"> <span class="align-middle">German</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{ asset('images/flags/italy.jpg') }}" alt="user-image"
                                        class="me-1" height="12"> <span class="align-middle">Italian</span>
                                </a>

                                <!-- item-->
                                <a href="javascript:void(0);" class="dropdown-item">
                                    <img src="{{ asset('images/flags/spain.jpg') }}" alt="user-image"
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            </script> © Ubold - <a href="https://coderthemes.com/" target="_blank">Coderthemes.com</a></div-->
                        </div>
                        <div class="col-md-6">
                ...
                <div class="tab-pane" id="chat-tab" role="tabpanel">
                    ...
                    <div>
                        ...
                        <a href="javascript: void(0);" class="text-reset notification-item">
                            <div class="d-flex align-items-start noti-user-item">
                                <div class="position-relative me-2">
                                    <img src="{{ asset('images/users/user-1.jpg') }}"
                                        class="rounded-circle avatar-sm" alt="user-pic">
