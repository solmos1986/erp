                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <label for="idProducto" class="form-label">Id <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="idProducto" placeholder="Enter amount"
                                        value="{{ $producto->idProducto }}" disabled>
                                </div>
                                <div class="col-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/" method="post" class="dropzone" id="myAwesomeDropzone"
                                ...
                                <div class="fallback">
                                    <input name="file" id="imagenProducto" value="{{ $producto->imagenProducto }}"
                                        type="file" multiple />
                                </div>
