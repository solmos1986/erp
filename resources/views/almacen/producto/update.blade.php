...
@section('contenido')
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <form action="/" method="post" enctype="multipart/form-data" class="dropzone" id="form_Editproduct"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="nomProducto" name="nomProducto" class="form-control"
                                        placeholder="ej : Apple iMac" value="{{ $producto->nomProducto }}">
                                </div>
                                    ...
                                    <select class="form-control select2" id="idCategoria" name="idCategoria">
                                        @foreach ($categoria as $cat)
                                            @if ($cat->idCategoria == $producto->idCategoria)
                                                <option value="{{ $cat->idCategoria }}" selected>{{ $cat->nomCategoria }}
                                                </option>
                                            @else
                                                <option value="{{ $cat->idCategoria }}">{{ $cat->nomCategoria }}
                                                </option>
                                            @endif
                                        @endforeach
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <input type="text" class="form-control" id="stockMinimo" name="stockMinimo"
                                            placeholder="Enter amount" value="{{ $producto->stockMinimo }}">
                                    </div>
                                </div>
                            </div>
                        </div> <!-- end card -->
...
@push('javascript')
    ...
    <script>
        ...
        $(document).on("click", ".guardar", function() {
            ...
            /*  $.ajax({
                 type: "post",
                 url: `${base_url}/almacen/producto/update`,
                 dataType: 'json',
                 data: {
