...
@section('contenido')
    ...
    <div class="card">
        <div class="card-body">
            @include('almacen.producto.components.form-producto-editar')
        </div>
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div class="text-center mb-3">
                <a href="{{ url('almacen/producto') }}"><button type="button"
                        class="btn btn-sm w-sm btn-light waves-effect">Cancelar</button></a>
                <button type="button" class="btn btn-sm w-sm btn-primary waves-effect waves-light store">Guardar</button>
            </div>
        </div>
    </div>
    <x-components.modal size="modal-xl" id="modal_tabla_compras" nameBtnSave="Guardar" nameBtnClose="Cancelar"
        idBtnSave="btn_save_producto">
        @include('almacen.producto.components.data-table-precio-compra')
    </x-components.modal>
@endsection
