<div class="row">
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="text-lg-end my-1 my-lg-0">
            <button type="button" class="nuevotp btn w-sm btn-success waves-effect waves-light"
                data-id="FORMAS DE PAGO">Nuevo</button>
            <div class="row">
                <br>
            </div>
        </div>
        ...
        <div class="table-responsive">
            <table id="bodyFormasPagos" class="bodyFormasPagos table table-borderless table-nowrap table-centered mb-0">
