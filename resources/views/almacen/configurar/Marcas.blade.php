<div class="row ">
    ...
    <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="text-lg-end my-1 my-lg-0">
            <button type="button" class="nuevom btn w-sm btn-success waves-effect waves-light" data-id="MARCAS"
                name="almacenpro">Nuevo</button>
            <div class="row">
                <br>
            </div>
        </div>
        <div class="table-responsive">
            <table id="bodyMarcas" class="bodyMarcas table table-borderless table-nowrap table-centered mb-0">
